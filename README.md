...
Navigate to any of the subfolders, say for Example by typing "cd Elastica/Example1_Rotating_Arm" and run the appropriate auto file by running the command "auto auto.filename" 
